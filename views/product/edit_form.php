                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-row">
                            ...
                            <input type="text" name="product_num" value="<?= $data['Product_number']; ?>"
                                   class="input-text ">
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <input type="text" name="curret_in" value="<?= $data['Current_inventory']; ?>"
                                   class="input-text ">
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-row">
                            ...
                            <input type="text" value="<?= $data['Short_description']; ?>" name="short_desk"
                                   class="input-text ">
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <textarea class="input-text " cols="5" rows="2"
                                      name="Long_description"><?= trim($data['Long_description']); ?></textarea>
                        </div>
                        <hr/>
                        ...
                        <small style="color:#999;"><b>NOTE</b>: Select a place, and then click "Upload file" to set the
                            image there.
                        </small>
