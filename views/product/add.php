...
<script type="text/javascript" charset="UTF-8" src="<?php echo _A_::$app->router()->UrlTo('upload/js/ajaxupload.3.5.js');?>"></script>
<link rel='stylesheet' charset="UTF-8" id='toko-style-css' href='<?php echo _A_::$app->router()->UrlTo('views/css/style.css');?>' type='text/css' media='all'/>
<link rel="stylesheet" charset="UTF-8" type="text/css" href="<?php echo _A_::$app->router()->UrlTo('upload/styles.css');?>">
