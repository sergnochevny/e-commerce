        ...
        <div class="search-container-title">
          <div class="row">
            ...
            <div class="h4 col-xs-10 search-result-list comment-text">
              <?= isset($search['a.colour'])?'<div class="label label-search-info">Like: '.$search['a.colour'].'</div>':''?>
        ...
        <div class="col-xs-12">
          <div class="form-row">
            <div class="row">
              ...
              <input type="text" class="input-text" placeholder="Like ..." name="search[a.colour]"
                     value="<?= isset($search['a.colour']) ? $search['a.colour'] : '' ?>">
            </div>
          </div>
        </div>
      </div>
