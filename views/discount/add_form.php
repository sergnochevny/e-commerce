...
<form method="POST" id="discount" action="<?= _A_::$app->router()->UrlTo('discounts/save_data'); ?>" class="enquiry-form">
    ...
    <br/>
    <div class="col-1">
        <div class="b_MODIFY_DISCOUNT_left form-row"><a class="required_field" data-promotion href="#promotion">Promotion</a>
        </div>
        ...
        <div id="l_ship"
             class="b_MODIFY_DISCOUNT_left form-row" <?= ($data['discount_type'] == '2') ? '' : 'style="display: none;"' ?>>
            <a class="required_field">Shipping</a>
        </div>
        <div id="f_ship"
             class="b_MODIFY_DISCOUNT_right form-row" <?= ($data['discount_type'] == '2') ? '' : 'style="display: none;"' ?>>
        ...
        <div class="b_MODIFY_DISCOUNT_right form-row">
            <?= ($data['users_check'] == "1") ? '<input type="radio" id="users_check1" name="users_check" value="1" class="input-checkbox" checked onclick="toggleUsers();">' : '<input type="radio" id="users_check1" name="users_check" value="1" class="input-checkbox" onclick="toggleUsers();">' ?>
            <span style="font-size: 12px;">All users</span>
        </div>
        <div class="b_MODIFY_DISCOUNT_left form-row">Users type</div>
        <div class="b_MODIFY_DISCOUNT_right form-row">
            <?= ($data['users_check'] == "2") ? '<input type="radio"  id="users_check2" name="users_check" value="2" class="input-checkbox" checked onclick="toggleUsers();">' : '<input type="radio"  id="users_check2" name="users_check" value="2" class="input-checkbox" onclick="toggleUsers();">' ?>
            <span style="font-size: 12px;">All new users</span>
        </div>
        <div class="b_MODIFY_DISCOUNT_left form-row"></div>
        <div class="b_MODIFY_DISCOUNT_right form-row">
            <?= ($data['users_check'] == "3") ? '<input type="radio" id="users_check3" name="users_check" value="3" class="input-checkbox" checked  onclick="toggleUsers();">' : '<input type="radio" id="users_check3" name="users_check" value="3" class="input-checkbox" onclick="toggleUsers();">' ?>
            <span style="font-size: 12px;">All registered users</span>
        </div>
        <div class="b_MODIFY_DISCOUNT_left form-row"></div>
        <div class="b_MODIFY_DISCOUNT_right form-row">
            <?= ($data['users_check'] == "4") ? '<input type="radio" id="users_check4" name="users_check" value="4" class="input-checkbox" checked onclick="toggleUsers();">' : '<input type="radio" id="users_check4" name="users_check" value="4" class="input-checkbox" onclick="toggleUsers();">' ?>
        ...
        <div class="b_MODIFY_DISCOUNT_left form-row"><a class="required_field" data-promotion href="#start_date">Start
                Date</a></div>
        <div class="b_MODIFY_DISCOUNT_right form-row">
        ...
        <div class="text-center">
            <input type="submit" value="Save" name="login" class="button" style="width: 150px;">
            <br/>

            <div class="results" style="color: red;"></div>
        </div>
</form>
<script src="<?= _A_::$app->router()->UrlTo('views/js/discount/add_form.js'); ?>"></script>