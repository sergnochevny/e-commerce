    ...
    <div class="col-md-12 col-xs-12 search_panel">
        <div class="row">
            <div class="col-md-10 col-xs-10">
                <input type="text" class="input-text" name="filter_select_search_<?= $filter_type; ?>"
    ...
    <div class="col-md-12 select_panel">
        <?php if (isset($filter)): ?>
            <ul class="filter_sel prod_sel_category">
                ...
                <?php endforeach; ?>
                <?php
                if (isset($filter_data_start) && isset($total)
                    && !((ceil($filter_data_start / FILTER_LIMIT) + 1) >= ceil($total / FILTER_LIMIT))
                ):?>
                    <li class="prod_sel_category_item">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="row text-center">
