      ...
      <div class="row">
        <div class="form-row">
          ...
          <div class="col-xs-12">
            <select name="promotion_type" class="input-text">
              <option value="0" <?= ($rows['promotion_type'] == 0) ? 'selected' : ''; ?>>
                Select the promotion type
              </option>
              <option value="1" <?= ($rows['promotion_type'] == 1) ? 'selected' : ''; ?>>
                Any purchase
              </option>
              <option value="2" <?= ($rows['promotion_type'] == 2) ? 'selected' : ''; ?>>
                First purchase
              </option>
              <option value="3" <?= ($rows['promotion_type'] == 3) ? 'selected' : ''; ?>>
            ...
            <div class="row">
              ...
              <div class="col-sm-7">
                <input type="text" name="coupon_code" id="coupon_code"
                       value="<?= $rows['coupon_code'] ?>" class="input-text">
              </div>
              <div class="col-sm-5">
                <label style="font-size: 12px; margin-top: 10px" for="generate_code">
                  <input type="checkbox" name="generate_code" id="generate_code" value="1"
                    <?= (isset($rows['generate_code']) && $rows['generate_code'] == '1') ? 'checked' : '' ?>
            ...
            <div class="row">
              ...
              <div class="col-xs-4 col-md-4">
                <input data-inputmask="'mask': '9[9].9[9]', 'greedy' : false" type="text"
                       name="discount_amount" value="<?= $rows['discount_amount'] ?>" id="discount_amount"
                       class="input-text ">
              </div>
              <div class="col-xs-2 col-md-2">
                <div class="row">
                  <select name="discount_amount_type" style="padding-left: 5px">
                    <option
                      value="1" <?= ($rows['discount_amount_type'] == '1') ? 'selected' : '' ?>>
                      $
                    </option>
                    <option
                      value="2" <?= ($rows['discount_amount_type'] == '2') ? 'selected' : '' ?>>
                      %
                    </option>
                  </select>
                </div>
              ...
              <div class="col-xs-6 col-md-6">
                <select name="discount_type" id="discount_type">
                  <option value="0" <?= ($rows['discount_type'] == '0') ? 'selected' : '' ?>>
                    Select
                  </option>
                  <option value="1" <?= ($rows['discount_type'] == '1') ? 'selected' : '' ?>>
                    Sub total
                  </option>
                  <option value="2" <?= ($rows['discount_type'] == '2') ? 'selected' : '' ?>>
                    Shipping
                  </option>
                  <option value="3" <?= ($rows['discount_type'] == '3') ? 'selected' : '' ?>>
            ...
            <div class="row">
              ...
              <div class="col-xs-6 col-md-4">
                <input data-inputmask="'mask': '9[9{3}].9[9]', 'greedy' : false" type="text"
                       name="required_amount" id="required_amount" value="<?= $rows['required_amount'] ?>"
                       class="input-text ">
              </div>
              <div class="col-xs-6 col-md-8" style="padding-left: 0">
                <select name="required_type">
                  <option value="0" <?= ($rows['required_type'] == '0') ? 'selected' : '' ?>>
                    Select
                  </option>
                  <option value="1" <?= ($rows['required_type'] == '1') ? 'selected' : '' ?>>
                    Total purchases
                  </option>
                  <option value="2" <?= ($rows['required_type'] == '2') ? 'selected' : '' ?>>
                    Total dollar amount
                  </option>
                </select>
              </div>
          ...
          <div class="col-xs-12">
            ...
            <div class="col-xs-12 panel panel-default"
              ...
              <div data-filter-panel-fabrics>
                <?php if(isset($rows['filter_products'])): ?>
          ...
          <div class="col-xs-12">
            <label for="allow_multiple">
              <input type="checkbox" value="1" name="allow_multiple"
                     id="allow_multiple" <?= $rows['allow_multiple'] == "1" ? 'checked' : '' ?>
                     class="input-checkbox">
              Allow multiple
          ...
          <div class="col-xs-12">
            <div class="row">
              <div class="col-xs-6">
                ...
                <input type="text" name="date_start" id="dateFrom" value="<?= $rows['date_start'] ?>"
                       class="input-text ">
              </div>
              <div class="col-xs-6">
                <label for="dateTo">End Date <i class="fa fa-question-circle" data-promotion
                                                href="#date_end"></i></label>
                <input type="text" name="date_end" value="<?= $rows['date_end'] ?>" id="dateTo" class="input-text ">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-xs-12 col-sm-6">
            <label for="countdown">
              <input type="checkbox" value="1" id="countdown"
                     name="countdown" <?= $rows['countdown'] == "1" ? 'checked' : '' ?>
                     class="input-checkbox">
        ...
        <div class="form-row">
          <div class="col-xs-12">
            ...
            <textarea name="discount_comment1" id="discount_comment1"><?= $rows['discount_comment1'] ?></textarea>
        ...
        <div class="form-row">
          <div class="col-xs-12">
            ...
            <textarea name="discount_comment2" id="discount_comment2"><?= $rows['discount_comment2'] ?></textarea>
            <small class="char-counter help-block">
        ...
        <div class="form-row">
          <div class="col-xs-12">
            ...
            <textarea name="discount_comment3" id="discount_comment3"><?= $rows['discount_comment3'] ?></textarea>
            <small class="char-counter help-block">
        ...
        <div class="form-row">
          <div class="col-xs-12 text-center">
            <input type="button" id="submit" class="button" style="width: 150px;"
                   value="<?= isset($rows['id']) ? 'Update' : 'Save'; ?>"/>
