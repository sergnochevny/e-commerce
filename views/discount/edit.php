...
?>
  ...
  <div class="popup" style="z-index: 99999999; font-size: 12px; color: black; max-width: 700px;">
    <h2>promotion</h2>
    <b>Any purchase</b>
    <p>no restriction on the type of purchase, uses only the restriction, users, and date fields to limit who receives
      the
      discount.</p>
    <b>First purchase</b>
...
<?php $this->registerJSFile(App::$app->router()->UrlTo('js/hints.min.js'), 4); ?>
<?php $this->registerJSFile(App::$app->router()->UrlTo('js/discount/edit.min.js'), 4); ?>