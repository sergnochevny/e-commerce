...
<link rel='stylesheet' href='<?php echo _A_::$app->router()->UrlTo('mnf'); ?>/views/css/simple-line-icons.css' type='text/css' media='all'/>
<link rel='stylesheet' href='<?php echo _A_::$app->router()->UrlTo('mnf'); ?>/views/css/matches.css' type='text/css' media='all'/>
...
<div class="site-container">
    ...
    <style>
        ...
        .toko-posts-grid .toko-post-detail > p > span.opa {
            background-image: url("<?php echo _A_::$app->router()->UrlTo('mnf');?>/views/images/bg-opa.png");
            bottom: 0;
            display: block;
            height: 80px;
            position: absolute;
                                            ...
                                            <div class="wpb_column vc_column_container vc_col-sm-12">
                                                <div class="wpb_wrapper">
                                                    <section class="toko-posts-grid">
                                                        ...
                                                        <b id="b_in_product">
                                                            <a id="all_to_basket"
                                                               href="<?php echo _A_::$app->router()->UrlTo('mnf'); ?>/add_all_to_cart">
                                                                Add
                                                                    All to Basket
                                                                
                                                            </a>
                                                            <a id="clear_matches"
                                                               href="<?php echo _A_::$app->router()->UrlTo('mnf'); ?>/clear_matches">
