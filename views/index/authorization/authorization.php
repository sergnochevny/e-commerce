                    ...
                    <article class="page type-page status-publish entry">
                        ...
                        <div class="entry-content">
                            <div class="woocommerce">
                                ...
                                <form method="POST" id="authorization" action="<?php echo $base_url; ?>/authorization"
                                      class="login">
                                    ...
                                    <p class="form-row">
                                        ...
                                        <input id="blogin" type="button" class="button" name="login" data-action="<?php echo $base_url; ?>/authorization" value="Login"/>
