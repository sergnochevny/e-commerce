            ...
            <div id="content" class="main-content-inner" role="main">
                <div
                    ...
                    <div class="images">
                        ...
                        if (isset($filename1)){
                        ?>
                        <a href="<?php echo isset($filename1) ? $filename1 : ''; ?>" itemprop="image"
                    ...
                    ?>
                        ...
                        <div class="thumbnails columns-4">
                            ...
                            if (!empty($userInfo['image2'])) {
                                ...
                                if (isset($filename1)) {
                                    ?>
                                    <a href="<?php echo isset($filename1) ? $filename1 : ''; ?>" class="zoom" title=""
                                    <?php echo isset($filename1) ? 'data-rel="prettyPhoto[product-gallery]"' : ''; ?>
                                    <?php echo isset($filename1) ? 'data-img = "' . $filename1 . '"' : '' ?>>
                                    <?php
                                }
                    ...
                    <div class="summary entry-summary">
                        <h1 class="product_title entry-title"><?= $userInfo['pname']; ?></h1>
