    ...
    <?php if (isset($cart_items) && strlen($cart_items) > 0): ?>
      <div class="col-xs-12 inner-offset-vertical">
        <div class="row">
          ...
          <div class="col-sm-2"><?= isset($sum_items) ? $sum_items : ''; ?></div>
        </div>
      </div>
    <?php endif; ?>
    ...
    <?php if (isset($cart_samples_items) && strlen($cart_samples_items) > 0): ?>
      ...
      <div class="row">
        <div class="col-xs-12 data-view">
          ...
          <div class="col-xs-12 table-list-row" id="samples_table">
            <div class="row">
      ...
      <div class="col-xs-12 inner-offset-vertical">
        <div class="row">
          <div class="col-sm-2 col-sm-offset-8"><b>Subtotal:</b></div>
          <div class="col-sm-2"><?= isset($sum_samples) ? $sum_samples : ''; ?></div>
        </div>
      </div>
