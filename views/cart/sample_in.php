<tr class="sample_item" data-pid="<?php echo $p_id; ?>"  data-row="samples">
    <td class="product-thumbnail">
        <a href="<?php echo _A_::$app->router()->UrlTo('shop/product',['p_id'=>$p_id,'cart'=>'1']); ?>">
            <img width="110" height="110" alt="" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image"
                 src="<?php echo $img_url; ?>">
        </a>
    </td>
    <td data-title="Product" class="product-name">
        <a href="<?php echo _A_::$app->router()->UrlTo('shop/product',['p_id'=>$p_id,'cart'=>'1']); ?>"><?php echo $item['Product_name']; ?></a>
    </td>
