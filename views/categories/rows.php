      ...
      <div class="row">
        <div class="col-sm-8 col">
          <?php
            ...
            $sort_url = App::$app->router()->UrlTo('categories', $order);
          ?>
      ...
      <div class="col-xs-12 table-list-row">
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-1 col-md-1 text-right action-buttons">
            <a data-modify href="<?= App::$app->router()->UrlTo('categories/edit', $prms) ?>">
              <i class="fa fa-2x fa-pencil"></i>
            </a>
            <a href="<?= App::$app->router()->UrlTo('categories/delete', $prms) ?>" data-delete rel="nofollow"
