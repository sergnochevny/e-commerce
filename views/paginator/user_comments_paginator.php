<li>
    <?php
    if ($prev_page > 0) {
        echo '<a class="prev page-numbers" href="' . $base_url . '/comments?page=' . $prev_page;
        if (isset($cat_id)) {
            echo '&cat=' . $cat_id;
        }
        echo '" >Prev</a>';
...
<li>
    <?php
    if ($page > 1) {
        echo '<a class="prev page-numbers" href="' . $base_url . '/comments?page=1';
        echo '" >First</a>';
    ...
    if ($i == $page) {
        ...
        <li>
            <a class="prev page-numbers"
                <?php
                echo 'href="' . $base_url . '/comments?page=' . $i . ' " ';
                ?>
            ><?php echo $i ?></a>
        </li>
        <?php
...
<li>
    <?php
    if ($page < $last_page) {
        echo '<a class="prev page-numbers" href="' . $base_url . '/comments?page=' . $last_page;
        echo '" >Last</a>';
...
<li>
    ...
    if ($next_page <= $last_page) {
        echo '<a class="prev page-numbers" href="' . $base_url . '/comments?page=' . $next_page;
        echo '" >Next</a>';
