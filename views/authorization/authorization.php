                    ...
                    <article class="page type-page status-publish entry">
                        ...
                        <div class="entry-content">
                            <div class="woocommerce">
                                ...
                                <form method="POST" id="authorization" action="<?php _A_::$app->router()->UrlTo('authorization'); ?>"
                                      class="login">
                                    ...
                                    <p class="form-row">
                                        ...
                                        <input id="blogin" type="button" class="button" name="login" data-action="<?php echo _A_::$app->router()->UrlTo('authorization'); ?>" value="Login"/>
