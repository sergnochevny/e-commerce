<tr>
    ...
    <td>
        <div class="text-center">
            ...
            <a class="text-success" id="view-comment"
               href="<?= _A_::$app->router()->UrlTo('comments/view', ['ID' => $row['id'], 'page' => $page]) ?>"
               title="View comment">
                <i class="fa fa-eye"></i>
            </a>

            <a class="text-danger" id="del_user"
               href="<?= _A_::$app->router()->UrlTo('comments/delete', ['ID' => $row['id'], 'page' => $page]); ?>"
    ...
    <td>
        <a <?= $row['moderated'] == '0' ? "class=\"text-danger\"" : "class=\"text-success\"" ?>
            id="public_comment"
            href="<?= _A_::$app->router()->UrlTo('comments/public', ['ID' => $row['id'], 'page' => $page]) ?>"
