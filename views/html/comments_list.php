    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-2 text-right action-buttons">
            <a <?= $row['moderated'] == '0' ? "class=\"text-danger public_comment\"" : "class=\"text-success public_comment\"" ?>
                href="<?= App::$app->router()->UrlTo('comments/public', $opt) ?>"
