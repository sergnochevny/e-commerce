<li class="dropdown">
    ...
    <a href="<?php echo _A_::$app->router()->UrlTo('admin');?>" class="dropdown-toggle" data-toggle="dropdown" rel="nofollow">
    ...
    <ul class="dropdown-menu topnav-account-dropdown">
        ...
        <li><a id="log_out" href="<?php echo _A_::$app->router()->UrlTo('admin/log_out');?>" rel="nofollow">Log Out</a></li>
    </ul>
</li>
