<ul role="group" class="dropdown-menu" id="sm-14573591911186943-2" aria-hidden="true"
    ...
    <!--<li class="menu-item menu-item-type-post_type menu-item-object-product">
        <a title="" href="#" class="has-submenu" id="sm-14573591911186943-11" aria-haspopup="true"
           aria-controls="sm-14573591911186943-12" aria-expanded="false">Accessories</a>
        <ul role="group" class="dropdown-menu sm-nowrap" id="sm-14573591911186943-12" aria-hidden="true"
            aria-labelledby="sm-14573591911186943-11" aria-expanded="false"
            style="width: auto; display: none; top: auto; left: 0px; margin-left: -194.047px; margin-top: -35px; min-width: 10em; max-width: 20em;">
            <li class="menu-item menu-item-type-post_type menu-item-object-product">
                <a title="" href="#">Faux Fur Throws</a>
            </li>
            <li class="menu-item menu-item-type-post_type menu-item-object-product">
                <a title="" href="#">Iron Rods &amp; Fixtures</a>
            </li>
            <li class="menu-item menu-item-type-post_type menu-item-object-product">
                <a title="" href="#">Pillows &amp; Buttons</a>
            </li>
            <li class="menu-item menu-item-type-post_type menu-item-object-product">
                <a title="" href="#">Designer Trims</a>
            </li>
        </ul>
    </li>-->
</ul>