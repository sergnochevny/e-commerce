    ...
    <div class="main-content main-content-shop">
        <div class="container">
                    ...
                    <div class="row">
                        <form action="orders_history" method="get">
                            ...
                            <div class="col-xs-11" style="padding-right: 0;">
                                <div class="row">
                                    <input type="text" style="width: 100%" value="<?= (isset($_GET['orders_search_query']) ? $_GET['orders_search_query'] : null) ?>" name="orders_search_query" class="col-lg-12" placeholder="Search...">
                                </div>
                            </div>
            ...
            <nav role="navigation" class="paging-navigation">
                ...
                <ul class='pagination'>
                    <?php echo $orders_history_paginator; ?>
                </ul>
            </nav>
