<div class="container">
  <div id="content" class="main-content-inner" role="main">
    <a href="<?= $back_url ?>" class="btn button">Back</a>
    <?php if($status > 0) { ?>
      <table cellspacing="0" class="shop_table shop_table_responsive proceed">
        ...
        <tr class="subtotal" style="color: #a5b63f">
          ...
          <td data-title="Shipping Discount" style="text-align:right;">
            <span class="track_code"><?= $track_code ?></span>
          </td>
          <td style="border-left: 1px solid rgba(0,0,0,.1)">
            Delivery date
          </td>
          <td class="text-right">
            <span class="ending_date"><?= $end_date ?></span>
          </td>
    ...
    <?php } else { ?>
      <span style="color: red;">Your order is being processed</span>
    <?php } ?>
    <table cellspacing="0" class="shop_table shop_table_responsive proceed">
      <thead>
      <tr>
