...
<head>
    ...
    <link rel="icon" href="<?php echo _A_::$app->router()->UrlTo('views/images/lf-logo.png'); ?>"/>
    <link rel="shortcut icon" href="<?php echo _A_::$app->router()->UrlTo('views/images/lf-logo.png'); ?>"/>
    <link rel="apple-touch-icon" href="<?php echo _A_::$app->router()->UrlTo('views/images/lf-logo.png'); ?>"/>
            ...
            <div class="copyright">
                <div class="row">
                    ...
                    <div class="footer-credit-right col-md-6 col-xs-12">
                        <p><img src="<?php echo _A_::$app->router()->UrlTo('views/images/temp/payment.png'); ?>" alt=""></p>
                    </div>
                </div>
            </div>
        </div>
...
if (isset($cart_enable)) {
    ?>
    <a href="<?php echo _A_::$app->router()->UrlTo('cart'); ?>" id="cart" rel="nofollow" class="cart-subtotal">
    ...
    <script type="text/javascript">
        (function ($) {
            $('span#cart_amount').load('<?php echo _A_::$app->router()->UrlTo('cart/amount');?>');
        })(jQuery);
    </script>
    <?php
}
