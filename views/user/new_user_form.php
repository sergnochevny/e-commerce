<form id="new_user_form" action="<?php echo $action;?>" method="post">
    ...
    <div class="col-1">
        ...
        <p class="form-row">
            ...
            <input type="checkbox"
                   name="Same_as_billing" <?php echo (isset($userInfo['Same_as_billing']) &&  $userInfo['Same_as_billing'] == 1)? 'checked' : '' ?>
        ...
        <p class="form-row">
            <label><strong> Organization:</strong></label>
            <input type="text" name="s_organization" value="<?= $userInfo['ship_organization'] ?>"
                   class="input-text ">
        </p>
        ...
        <p class="form-row">
            ...
            <select name="s_country" value="<?= $userInfo['ship_country'] ?>" class="input-text ">
                <option <?php echo (isset($userInfo['ship_country']) && !empty($userInfo['ship_country']{0}))?'':'selected'?> disabled value="0">Select Country</option>
