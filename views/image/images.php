        ...
        <div class="b_modify_images_main_pic"
          ...
          <?php if(!empty($image1{0})) { ?>
            <div class='b_modify_images_pic_del'>
              <a href='<?= $pid ?>' data-img_idx='1' class='pic_del_images'>
                <span>&times;</span>
              </a>
            </div>
          <?php } ?>
          ...
          <label>
            ...
            <div class='b_modify_images_pic'
              ...
              <?php if(!empty($image2{0})) { ?>
                <div class='b_modify_images_pic_del'>
                  <a href='<?= $pid ?>' data-img_idx='2' class='pic_del_images'>
                    <span>&times;</span>
                  </a>
                </div>
                <div class='b_modify_images_pic_make_main'>
                  <div data-p_id='<?= $pid ?>' data-img_idx='2'
          ...
          <label>
            ...
            <div class='b_modify_images_pic'
              ...
              <?php if(!empty($image3{0})) { ?>
                <div class='b_modify_images_pic_del'>
                  <a href='<?= $pid ?>' data-img_idx='3' class='pic_del_images'>
                    <span>&times;</span>
                  </a>
                </div>
                <div class='b_modify_images_pic_make_main'>
                  <div data-p_id='<?= $pid ?>' data-img_idx='3'
                       class='b_modify_images_pic_main_icon'>
                    <i class="fa fa-desktop" title="Set as main image"></i>
                  </div>
                </div>
          ...
          <label>
            ...
            <div class='b_modify_images_pic'
              ...
              <?php if(!empty($image4{0})) { ?>
                <div class='b_modify_images_pic_del'>
                  <a href='<?= $pid ?>' data-img_idx='4' class='pic_del_images'>
                    <span>&times;</span>
                  </a>
                </div>
                <div class='b_modify_images_pic_make_main'>
                  <div data-p_id='<?= $pid ?>' data-img_idx='4'
                       class='b_modify_images_pic_main_icon'>
                    <i class="fa fa-desktop" title="Set as main image"></i>
                  </div>
                </div>
          ...
          <label>
            ...
            <div class='b_modify_images_pic'
              ...
              <?php if(!empty($image5{0})) { ?>
                <div class='b_modify_images_pic_del'>
                  <a href='<?= $pid ?>' data-img_idx='5' class='pic_del_images'>
                    <span>&times;</span>
                  </a>
                </div>
                <div class='b_modify_images_pic_make_main'>
                  <div data-p_id='<?= $pid ?>' data-img_idx='5'
                       class='b_modify_images_pic_main_icon'>
                    <i class="fa fa-desktop" title="Set as main image"></i>
                  </div>
                </div>
