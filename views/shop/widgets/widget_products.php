<li>
    <div style="position: relative;">
        ...
        <?php if ($sys_hide_price == 0 && $hide_price == 0) { ?> <ins><span class="amount"><?= $format_price; ?></span></ins> <?php } ?>
        <?php if (isset($saleprice) && ($price != $saleprice)) { ?>
            <span class="price" style="float:right;color: red;font-size: 11px;">Sale: <ins><span class="amount_wd"><?= $format_sale_price; ?></span></ins></span>
        <?php } ?>
    </div>
</li>
