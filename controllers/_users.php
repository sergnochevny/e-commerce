<?php
  ...
  class Controller_Users extends Controller_FormSimple {
    ...
    protected function load(&$data) {
      ...
      $data = [
        'aid' => _A_::$app->get('aid'),
        'email' => Model_Users::validData(_A_::$app->post('email')),
        'bill_firstname' => Model_Users::validData(_A_::$app->post('bill_firstname')),
        'bill_lastname' => Model_Users::validData(_A_::$app->post('bill_lastname')),
        'bill_organization' => Model_Users::validData(_A_::$app->post('bill_organization')),
        'bill_address1' => Model_Users::validData(_A_::$app->post('bill_address1')),
        'bill_address2' => Model_Users::validData(_A_::$app->post('bill_address2')),
        'bill_province' => Model_Users::validData(_A_::$app->post('bill_province')),
        'bill_city' => Model_Users::validData(_A_::$app->post('bill_city')),
        'bill_country' => Model_Users::validData(_A_::$app->post('bill_country')),
        'bill_postal' => Model_Users::validData(_A_::$app->post('bill_postal')),
        'bill_phone' => Model_Users::validData(_A_::$app->post('bill_phone')),
        'bill_fax' => Model_Users::validData(_A_::$app->post('bill_fax')),
        'bill_email' => Model_Users::validData(_A_::$app->post('bill_email')),
        'ship_firstname' => Model_Users::validData(_A_::$app->post('ship_firstname')),
        'ship_lastname' => Model_Users::validData(_A_::$app->post('ship_lastname')),
        'ship_organization' => Model_Users::validData(_A_::$app->post('ship_organization')),
        'ship_address1' => Model_Users::validData(_A_::$app->post('ship_address1')),
        'ship_address2' => Model_Users::validData(_A_::$app->post('ship_address2')),
        'ship_city' => Model_Users::validData(_A_::$app->post('ship_city')),
        'ship_province' => Model_Users::validData(_A_::$app->post('ship_province')),
        'ship_country' => Model_Users::validData(_A_::$app->post('ship_country')),
        'ship_postal' => Model_Users::validData(_A_::$app->post('ship_postal')),
        'ship_phone' => Model_Users::validData(_A_::$app->post('ship_phone')),
        'ship_fax' => Model_Users::validData(_A_::$app->post('ship_fax')),
        'ship_email' => Model_Users::validData(_A_::$app->post('ship_email')),
      ];
