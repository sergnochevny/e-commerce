...
class ControllerProduct extends ControllerFormSimple{
  ...
  protected function load(&$data){
    ...
    $data['width'] = ModelProduct::sanitize(App::$app->post('width')) ? App::$app->post('width') : '';
    $data['priceyard'] = ModelProduct::sanitize(App::$app->post('priceyard')) ? App::$app->post('priceyard') : '';
    $data['hideprice'] = ModelProduct::sanitize(!is_null(App::$app->post('hideprice'))) ? App::$app->post('hideprice') : '';
    ...
    $data['manufacturerId'] = ModelProduct::sanitize(App::$app->post('manufacturerId')) ? App::$app->post('manufacturerId') : '';
    ...
    $data['weight_id'] = ModelProduct::sanitize(App::$app->post('weight_id') ? App::$app->post('weight_id') : '');
