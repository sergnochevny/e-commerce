...
return [
  'define' => [
    'ENABLE_SEF' => true, 'DS' => '/', 'SITE_PATH' => function(){
      return str_replace(DIRECTORY_SEPARATOR, DS, realpath(dirname(__FILE__) . DS) . DS);
    },

    'FILTER_LIMIT' => 50, 'DEFAULT_SHIPPING' => 3, 'TITLE_MAX_CHARS' => 50, 'TITLE_MIN_CHARS' => 5,
    'DATA_MAX_CHARS' => 1000, 'DATA_MIN_CHARS' => 15, 'DEMO' => 1, 'DISCOUNT_STRING_JOINER' => '<br />',
    'DISCOUNT_TYPE_NONE' => 0, 'DISCOUNT_TYPE_SUBTOTAL' => 1, 'DISCOUNT_TYPE_SHIPPING' => 2, 'DISCOUNT_TYPE_TOTAL' => 3,
    'DISCOUNT_CATEGORY_ALL' => 1, 'DISCOUNT_CATEGORY_COUPON' => 2, 'DISCOUNT_CATEGORY_SHIPPING' => 3,
    ...
    'SAMPLES_DESCRIPTION_PREFIX' => 'SAMPLE - ', 'SAMPLES_PURCHASE_BEFORE_TIME_HOUR' => 3,
    'SAMPLES_PURCHASE_BEFORE_TIME_MINUTE' => 00, 'SAMPLES_PURCHASE_AFTER_DAY' => 1, 'SAMPLES_PURCHASE_BEFORE_DAY' => 4,
    ...
    'RATE_EXPRESS_LIGHT_MULTIPLIER' => 3.25, 'RATE_EXPRESS_MEDIUM' => 27.85,
    #rate to ship medium products via express
    'RATE_EXPRESS_MEDIUM_MULTIPLIER' => 3.75, 'RATE_EXPRESS_HEAVY' => 27.85,
    #rate to ship heavy products via express
    'RATE_EXPRESS_HEAVY_MULTIPLIER' => 4.75, 'RATE_GROUND_LIGHT' => 20.95,
    #rate to ship light products via ground
    'RATE_GROUND_LIGHT_MULTIPLIER' => 3.00, 'RATE_GROUND_MEDIUM' => 20.95,
    #rate to ship medium products via ground
    'RATE_GROUND_MEDIUM_MULTIPLIER' => 3.35, 'RATE_GROUND_HEAVY' => 22.85,
    #rate to ship heavy products via ground
    'RATE_GROUND_HEAVY_MULTIPLIER' => 4.00,

    'HIDE_REGULAR_PRICE' => 0, 'SAMPLE_EXPRESS_SHIPPING' => 1, 'CSV_USE_GZ' => 0,
    'CSV_FIELDS' => 'email,bill_firstname,bill_lastname', 'CAPTCHA_RELEVANT' => 300,

    'SHOP_SPECIALS_AMOUNT' => 30, 'SHOP_BSELLS_AMOUNT' => 60,

    'PRICE_GROUPS_COUNT' => 24,

    'LIGHT_FABRIC' => 1, 'MEDIUM_FABRIC' => 2, 'HEAVY_FABRIC' => 3, 'YRDS_FOR_MULTIPLIER' => 2.0,
    #total yardage allowed before a mulitplier is added
  ], 'ini_set' => [
    'display_errors' => 'On', 'mysql.connect_timeout' => 60, 'error_reporting' => (E_ALL & (~E_DEPRECATED)),
    'always_populate_raw_post_data' => -1,
  ], 'date_default_timezone_set' => ['UTC'], 'setlocale' => [LC_ALL, 'en_US'], 'setlocale' => [LC_TIME, 'UTC'],
  'DBS' => [
    'connections' => [
      'default' => [
        'connection' => "localhost", 'user' => "root", 'password' => "", //          'user' => "newiluvf",
        //          'password' => "dd94ZXG6",
        'db' => [
          'default' => 'iluvfabrix'
        ]
  ...
  ], 'layouts' => "main_layout", 'per_page_items' => ['6', '12', '24'],
];
