<?php
  return [
    'define' => [
      ...
      'DISCOUNT_CATEGORY_PRODUCT' => 4,
      #define the variables needed for the defaults for the samples
      'SAMPLES_PRICE_EXPRESS_SHIPPING' => 39.95,
      #define the variables needed for the defaults for the samples
      'SAMPLES_QTY_MULTIPLE_MIN' => 2,          #the minimum number of samples to qualify for the multiple price
      'SAMPLES_QTY_MULTIPLE_MAX' => 5,          #the maximum number of samples to qualify for the multiple price, after this number they are charged the additional price
      ...
      'SAMPLES_PRICE_WITH_PRODUCTS' => 4.00,      #the price charge for samples if they are purchased with any other products
