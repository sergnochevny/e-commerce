...
Class Model_User extends Model_Model
{
    ...
    public static function user_exist($email, $id = null)
    {
        if (isset($id)) {
    ...
    public static function user_exist_by_id($id = null)
    {
        if (isset($id)) {
    ...
    public static function insert_user($user_Same_as_billing, $user_email, $password, $user_first_name, $user_last_name, $user_organization,
