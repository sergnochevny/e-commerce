<?php
  ...
  Class Model_User extends Model_Model {
    ...
    public static function save($user_Same_as_billing, $user_email, $user_first_name, $user_last_name, $user_organization,
      ...
      $user_s_country, $user_s_zip, $user_s_telephone, $user_s_fax, $user_s_email, $password, $user_id) {
      $timestamp = time();
      if(!isset($user_id)){
