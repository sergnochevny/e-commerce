    ...
    protected static function build_where(&$filter) {
      ...
      if(!empty($filter["c.id"])) {
        if(is_array($filter["c.id"])) {
          ...
          $result[] = "c.id = '" . static::escape(static::strip_data(static::sanitize($filter["c.id"]))) . "'";
        }
      }
      if(!empty($filter["d.id"])) {
        if(is_array($filter["d.id"])) {
          ...
          $result[] = "d.id = '" . static::escape(static::strip_data(static::sanitize($filter["d.id"]))) . "'";
        }
      }
      ...
      if(isset($filter['hidden']["fabrix_orders.aid"])) $result[] = "fabrix_orders.aid = '" . static::escape(static::strip_data(static::sanitize($filter['hidden']["fabrix_orders.aid"]))) . "'";
